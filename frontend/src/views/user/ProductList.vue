...
.page-hero { display: flex; align-items: center; justify-content: space-between; gap: 24px; padding: 34px 42px; border: 1px solid #303640; border-radius: 8px; color: #fff; background: var(--tech); }
.eyebrow { margin: 0 0 10px; color: #ff806d; font-size: 11px; font-weight: 800; letter-spacing: 2px; }
.page-hero h1 { margin: 0 0 10px; font-size: 32px; }
.page-hero p:last-child { margin: 0; color: #bec3ca; }
.hero-stat { min-width: 140px; padding: 16px 22px; border: 1px solid rgba(242,85,61,.45); border-radius: 8px; text-align: center; background: rgba(242,85,61,.10); }
.hero-stat strong { display: block; color:#ff806d; font-size: 28px; }.hero-stat span { color: #c7cbd0; font-size: 12px; }
.filter-panel { margin-top: 18px; padding: 20px 22px; border: 1px solid var(--line); border-radius: 8px; background: #fff; }
.filter-row { display: flex; align-items: center; gap: 12px; }.keyword-input { flex: 1; min-width: 220px; }.filter-select { width: 180px; }
.category-row, .active-row { display: flex; align-items: center; flex-wrap: wrap; gap: 8px; margin-top: 18px; padding-top: 18px; border-top: 1px solid #edf2f4; }.filter-label { flex: 0 0 auto; margin-right: 8px; color: #637b89; font-size: 13px; font-weight: 700; }.category-chip { padding: 7px 15px; border: 0; border-radius: 6px; color: #607786; background: transparent; cursor: pointer; font-size: 13px; }.category-chip:hover { color: var(--brand); background: var(--brand-soft); }.category-chip.active { color: #fff; background: var(--brand); }.clear-all { color: var(--brand); cursor: pointer; font-size: 13px; }
.results-toolbar { display: flex; align-items: baseline; justify-content: space-between; margin: 28px 0 16px; }.results-toolbar h2 { display: inline; margin: 0 12px 0 0; color: var(--ink); font-size: 22px; }.result-count, .loading-text { color: #8296a2; font-size: 13px; }.loading-text { color: var(--brand); }
.product-grid { min-height: 120px; }.product-card { overflow: hidden; margin-bottom: 18px; border: 1px solid var(--line); border-radius: 8px; background: #fff; cursor: pointer; transition: transform .2s, box-shadow .2s; }.product-card:hover { transform: translateY(-3px); border-color:var(--brand-border); box-shadow: 0 12px 28px rgba(44,35,32,.10); }.image-wrap { position: relative; height: 220px; background: #f6f8f9; }.product-image { display: block; width: 100%; height: 100%; }.image-error { display: grid; place-items: center; height: 100%; color: #a4b2ba; font-size: 13px; }.stock-tag { position: absolute; top: 12px; right: 12px; }.product-body { padding: 14px 16px 16px; }.product-tags { display: flex; gap: 6px; min-height: 24px; }.product-body h3 { overflow: hidden; margin: 11px 0 7px; color: var(--ink); font-size: 16px; text-overflow: ellipsis; white-space: nowrap; }.product-body p { display: -webkit-box; height: 40px; overflow: hidden; margin: 0; color: #7b8e9b; font-size: 13px; line-height: 1.55; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }.product-foot { display: flex; align-items: baseline; justify-content: space-between; margin-top: 14px; }.product-foot strong { color: var(--brand); font-size: 22px; }.product-foot span { color: #9aaab3; font-size: 12px; }.empty-state { margin: 40px 0; }.pagination-wrap { display: flex; justify-content: center; padding: 12px 0 24px; }
